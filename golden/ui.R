...
shinyUI(
    tabsetPanel(id = 'tabs',
                ...
                tabPanel("Specify variables",
                         pageWithSidebar(
                             
                             headerPanel(tags$html(tags$img(src="/images/Circles0.75in.png" ,alt="xxx"),
                                                   tags$a(href="http://www.protolife.com","ProtoLife")),windowTitle="PDT"),
                             sidebarPanel(
                                 selectInput('addrm','Add or remove a variable?',choices=list('add'=0,'remove'=1),selected=0),
                                 h2("Add a variable:"),
                                 ...
                                 conditionalPanel(
                                     condition = "input.vtype == 4 & input.tabs=='Specify variables'",
